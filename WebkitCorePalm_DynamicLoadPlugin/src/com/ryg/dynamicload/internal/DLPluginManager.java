...
public class DLPluginManager {
    ...
    public DLPluginPackage loadApk(String dexPath) {
        ...
        // by host.
		return loadApk(dexPath, true, null);
    }
     ...
     * @return
     */
	private DLPluginPackage preparePluginEnv(PackageInfo packageInfo,
			String dexPath, ClassLoader parentClassLoader) {
	...
	private DexClassLoader createDexClassLoader(String dexPath,
			ClassLoader parentClassLoader) {
		// 此处做了修改，可以传入一个classloader，以此为基础添加类
		...
		DexClassLoader loader = new DexClassLoader(dexPath, dexOutputPath,
				mNativeLibDir, parentClassLoader);
        return loader;
    }
